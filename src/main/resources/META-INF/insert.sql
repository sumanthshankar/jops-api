...
insert into users(user_id, active, email_id, first_name, last_name, password) 
values(1, true, 'test1@test1.com', 'Test1 First', 'Test1 Last', '$2a$10$VuBLEOY9d9GLU4TPwqjtQef0MQID5BnH93Qcf8X3h5So0myMjSqdO');
